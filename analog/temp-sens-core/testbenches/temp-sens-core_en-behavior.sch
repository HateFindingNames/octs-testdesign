...
B 2 450 -1480 1250 -1080 {flags=graph
y1=0
y2=1.3
ypos1=0
ypos2=1.3
...
N 2320 -340 2420 -340 {lab=out}
N 2250 -300 2250 -210 {lab=#net19}
N 1200 -340 1240 -340 {lab=out}
N 1200 -340 1200 -260 {lab=out}
N 2320 -340 2320 -260 {lab=out}
N 2300 -340 2320 -340 {lab=out}
...
N 160 -430 160 -360 {lab=EN}
N 160 -430 240 -430 {lab=EN}
N 920 -540 1070 -540 {lab=EN}
N 920 -140 1070 -140 {lab=EN_n}
N 280 -430 280 -410 {lab=EN_n}
N 240 -430 240 -380 {lab=EN}
N 280 -510 280 -480 {lab=VDD}
N 280 -380 280 -350 {lab=0}
N 280 -430 330 -430 {lab=EN_n}
N 280 -450 280 -430 {lab=EN_n}
N 240 -480 240 -430 {lab=EN}
N 1010 -270 1110 -270 {lab=0}
N 1110 -270 1110 -260 {lab=0}
N 1010 -420 1110 -420 {lab=VDD}
N 1110 -430 1110 -420 {lab=VDD}
N 90 -380 90 -360 {lab=VDD}
...
C {vsource.sym} 90 -330 0 0 {name=Vdd value=1.2 savecurrent=false}
...
C {gnd.sym} 90 -300 0 0 {name=l1 lab=0}
...
C {vdd.sym} 90 -380 0 0 {name=l9 lab=VDD}
...
C {lab_pin.sym} 160 -380 2 0 {name=p1 sig_type=std_logic lab=EN}
C {lab_pin.sym} 2420 -340 2 0 {name=p7 sig_type=std_logic lab=out}
C {gnd.sym} 160 -300 0 0 {name=l12 lab=0}
...
C {simulator_commands.sym} 0 -990 0 0 {name=EN_behavior
simulator=ngspice
only_toplevel=false 
value="
* ngspice commands
...
meas tran tperiod \\
+ TRIG v(out) VAL=0.9 RISE=2 TD=100n \\
+ TARG v(out) VAL=0.9 RISE=3 TD=100n

let f = 1/tperiod

write temp-sens-core_en-behavior.raw time out en en_n vgp vgn
.endc
"
}
C {lab_pin.sym} 330 -430 2 0 {name=p2 sig_type=std_logic lab=EN_n}
...
C {sg13cmos5l_pr/sg13_lv_nmos.sym} 260 -380 0 0 {name=M6
l=0.13u
w=1u
ng=1
m=1
...
C {sg13cmos5l_pr/sg13_lv_pmos.sym} 260 -480 0 0 {name=M7
l=0.13u
w=2u
ng=1
m=1
...
C {gnd.sym} 280 -350 0 0 {name=l5 lab=0}
C {vdd.sym} 280 -510 0 0 {name=l23 lab=VDD}
C {vsource.sym} 160 -330 0 0 {name=V2 value="pulse 0 1.2 50n 1n 1n 200n 400n" savecurrent=false}
